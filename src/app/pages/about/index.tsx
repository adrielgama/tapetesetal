...
const AboutText: React.FC = () => (
  <div className="text-center container flex flex-col items-center justify-center gap-10">
    ...
    <p className="text-justify text-sm md:w-2/3 mb-24">
      A Tapetes & Tal é uma empresa especializada na fabricação de tapetes em
      vinil, emborrachados e vulcanizados que vem oferecendo produtos de
      qualidade aos seus clientes desde 1992. Utilizando tecnologia moderna e
      matéria-prima de primeira linha, a nossa empresa garante a durabilidade em
      seus produtos e serviços. Além disso, primamos por manter uma relação de
      profissionalismo, pontualidade e respeito com os nossos clientes. Nossa
      meta é continuar ofertando produtos que integrem soluções inovadoras e
      sustentáveis de forma personalizada.
    </p>
  </div>
);
